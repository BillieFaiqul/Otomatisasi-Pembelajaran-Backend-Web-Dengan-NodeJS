...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //     'updated_at' => now(),
        // ], [
            'title' => 'asycnchronous-programming',
        ...
        $project_asynchronous_programming = Project::where('title', 'asycnchronous-programming')->first();

        //images
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/images/asycnchronous-programming.png'))->toMediaCollection('project_images', 'public_projects_files');

        //files
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/files/.env'))->toMediaCollection('project_files', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/files/package.json'))->toMediaCollection('project_files', 'public_projects_files');
        //tests


        //guides
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/guides/Guide ASP01.pdf'))->toMediaCollection('project_guides', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/guides/Guide ASP02.pdf'))->toMediaCollection('project_guides', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/guides/Guide ASP03.pdf'))->toMediaCollection('project_guides', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/guides/Guide ASP04.pdf'))->toMediaCollection('project_guides', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/guides/Guide ASP05.pdf'))->toMediaCollection('project_guides', 'public_projects_files');

        //supplements
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/supplements/.env.example'))->toMediaCollection('project_supplements', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/supplements/.gitignore'))->toMediaCollection('project_supplements', 'public_projects_files');
        
        //zips
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/zips/guides.zip'))->toMediaCollection('project_zips', 'public_projects_files');
        $project_asynchronous_programming->addMedia(storage_path('app/public/assets/projects/asycnchronous-programming/zips/supplements.zip'))->toMediaCollection('project_zips', 'public_projects_files');
